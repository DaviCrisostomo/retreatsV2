...
function getRetreat(id) {
    fetch('http://localhost:8080/api/v1/retreats/' + id)
        .then((res) => {
            ...
            div.innerHTML = `<div class="card col-5 m-1 mx-auto">
        <img class="card-img-top" src="img/_meditation.png" />
        <div class="card-body">
          ...
          `
          fafafunction(rooms);
          button.innerHTML = ` <button class="button btn-lg btn-primary" id="calculate-button">Total</button>
